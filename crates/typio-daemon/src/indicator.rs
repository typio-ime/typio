...
//!
//! The indicator shares the candidate panel's
...
/// Announcement salience. Mirrors typio-runtime's `ModeSalience`. Governs
...
/// Mirrors the fields of typio-runtime's `EngineMode` that the
...
/// Indicator configuration. Production values are read from typio-runtime config
...
impl IndicatorConfig {
    /// Build from raw typio-runtime config values. `duration_ms` is clamped to
