...
//!
//! Joins a composition's segments into the flat string shown inline by the
//! compositor and resolves the display cursor. Pure — no I/O.

/// A single preedit segment. Only the text matters for plain (unformatted)
/// display.
