...
- [typio ADR-0008: TIP v1 — IPC Protocol](../../../../docs/adr/0008-ipc-protocol-resource-namespaces-uds-only.md) — the underlying RPC vocabulary the CLI maps to.
- [libtypio ADR-0008: engine properties unified into the config schema](../../../libtypio/docs/adr/0008-engine-properties-unified-into-config-schema.md) — why the `rime` namespace is no longer needed.
