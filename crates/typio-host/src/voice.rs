...
//!
//! The host supplies a PipeWire-backed [`AudioSource`]; typio-core owns the
...
use typio::voice::session::{AudioSink, AudioSource, VoiceSession};
use typio::voice::types::{VoiceEvent, VoiceState};
...
pub enum VoiceOutcome {
    /// Recognised text, tag-filtered and trimmed by typio-core.
    Result(String),
