...
//!
//! Ported to use the shared flux-text and flux-canvas stack, removing
//! the heavy pure-Rust fallback dependencies.
...
use flux_text_sys::{
    flux_text_create, flux_text_desc, flux_text_destroy, flux_text_draw, flux_text_family,
    flux_text_measure, flux_text_style,
};
