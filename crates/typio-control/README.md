...
cargo install --path crates/typio-control
```
...
The daemon (`typio`) must be running. See the
[command-line interface reference](../../docs/reference/cli.md) for the full
command and RPC mapping and
[ADR-0004](../../docs/adr/archive/cli-control/0004-resource-verb-cli-schema-on-tip.md)
