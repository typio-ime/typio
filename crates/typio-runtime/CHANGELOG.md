...
- **Language-first switching** ([ADR-0018](../../docs/adr/archive/framework-core/adr/0018-language-first-switching.md)).
...
- **Typio Engine Protocol** ([ADR-0017](../../docs/adr/archive/framework-core/adr/0017-typio-engine-protocol.md)).
  ...
  reserved for logs.
- **Out-of-process active-mode reflection** ([ADR-0016](../../docs/adr/archive/framework-core/adr/0016-out-of-process-active-mode-reflection.md)).
...
- **`TypioEngineManager` removed.** `TypioRegistry` (see
  [ADR-0005](../../docs/adr/archive/framework-core/adr/0005-internal-engine-backend-abstraction.md)) is now the sole engine-management C surface. All
...
- **`TypioCandidateList` removed.** Candidates are delivered as part of
  ...
  [ADR-0006](../../docs/adr/archive/framework-core/adr/0006-composition-state-and-commit-event.md));
...
- **`docs/reference/api/` split by audience.** The single mixed folder is
  ...
  [ADR-0003](../../docs/adr/archive/framework-core/adr/0003-plugin-engine-abi-dual-category.md) is
...
- **Engine ABI rewritten — pre-1.0 reset.**
  ...
  [`docs/adr/archive/framework-core/dev/abi-stability.md`](../../docs/adr/archive/framework-core/dev/abi-stability.md) for the new
