...
ADRs are append-only records of significant design decisions in `typio-runtime` —
the platform-neutral Rust runtime. Once accepted, they are not edited; a new
ADR supersedes an old one if a decision changes.

The repository-wide [ADR-0046](../../../../adr/0046-engine-protocol-only-runtime.md)
...
- Current design docs: [Engine contract](../../../../explanation/engine-contract.md)
  and the other pages under `docs/explanation/`
- Developer notes: [dev/ index](../dev/index.md)
- Host-side ADRs: see the root `docs/adr/` set
- CLI ADRs: see `../../cli-control/index.md`
